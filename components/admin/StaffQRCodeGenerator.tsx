  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold text-white">QR Code Absensi Tendik</h1>
      </div>
      <Card>
        <div className="flex flex-col items-center space-y-6 max-w-md mx-auto text-center">
            ...
            <p className="text-sm text-slate-400">
                QR code ini bersifat <strong className="text-amber-400">statis (tidak berubah)</strong>. Silakan cetak dan tempelkan di pintu masuk. Tendik harus memindai kode ini di area sekolah untuk mencatat waktu datang dan pulang.
            </p>
        </div>
      </Card>
